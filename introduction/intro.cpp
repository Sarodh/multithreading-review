...
int main() {
    ...
    cout<<"Main thread ID: "<<this_thread::get_id()<<endl; // get unique identifier of current thread.
    ...
    cout<<"Child thread ID: "<<t1.get_id()<<endl; // get unique thread identifier of child thread
